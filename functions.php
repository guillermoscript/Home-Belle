...
if (!function_exists('oceanwp_wcmenucart_m	enu_item')) {
	function oceanwp_wcmenucart_menu_item()
	{
		...
		if (
			true == get_theme_mod('ocean_woo_menu_icon_hide_if_empty', false)
		...
		<?php } else { ?>
			<a href="<?php echo esc_url($url); ?>" class="<?php echo esc_attr($classes); ?>">
				<span class="wcmenucart-count">
					<svg xmlns="http://www.w3.org/2000/svg" width="25.917" height="23.754" viewBox="0 0 25.917 23.754">
						<path id="shopping-cart" d="M24.852,25.663H4.588l-.3-3.356a1.064,1.064,0,0,0-1.06-.969H1.064a1.064,1.064,0,0,0,0,2.129H2.254L3.478,37.105A4.1,4.1,0,0,0,5.011,39.88a3.226,3.226,0,1,0,5.575.887h5.825a3.227,3.227,0,1,0,3.034-2.129H7.559a1.977,1.977,0,0,1-1.817-1.2l17.01-1a1.064,1.064,0,0,0,.97-.8l2.163-8.65a1.065,1.065,0,0,0-1.033-1.322Zm-17.3,17.3a1.1,1.1,0,1,1,1.1-1.1A1.1,1.1,0,0,1,7.552,42.963Zm11.894,0a1.1,1.1,0,1,1,1.1-1.1A1.1,1.1,0,0,1,19.446,42.963Zm2.4-8.6-16.391.963-.676-7.532H23.489Z" transform="translate(0 -21.338)" />
					</svg>
...
function coupon_error_message_change($err, $err_code, $parm)
{
	switch ($err_code) {
		case 105:
			...
			$err = sprintf(__('Cupón "%s" no existe', 'woocommerce'), $parm->get_code());
			break;
	}
	return $err;
}
