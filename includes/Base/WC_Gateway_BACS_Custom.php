<?php
/**
 * Class WC_Gateway_BACS_Custom file.
 *
...
// add_action( 'init', 'asia_init_gateway_class' );

function asia_init_gateway_class() {

class WC_Gateway_BACS_Custom extends WC_Payment_Gateway {
	...
	public function payment_fields() {
		if( is_checkout() && $_REQUEST['payment_method'] === $this->id ) {
	
			// add_action( 'woocommerce_checkout_before_customer_details', array( $this, 'payment_fields' ) );
